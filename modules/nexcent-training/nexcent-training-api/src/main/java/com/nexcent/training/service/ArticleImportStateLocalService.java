...
/**
 * Provides the local service interface for ArticleImportState. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Nexcent Training
 * @see ArticleImportStateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ArticleImportStateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nexcent.training.service.impl.ArticleImportStateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the article import state local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ArticleImportStateLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ArticleImportState addArticleImportState(
	...
	public ArticleImportState createArticleImportState(
	...
	public ArticleImportState deleteArticleImportState(
		ArticleImportState articleImportState);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ArticleImportState getArticleImportState(long articleImportStateId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ArticleImportState> getArticleImportStates(int start, int end);
